...
arrayPortafol.forEach((target) => {
  ...
  <div class="">
    <div class="">
      <div class="bg-white container shadow p-2 rounded-lg text-gray-800 hover:shadow-lg">
        ...
        <div class="py-2 px-2">
          ...
          <div class=" font-bold font-title text-center">${target.tittle}</div>
          <div class="text-sm font-light text-center my-2">${target.subtitle}</div>
          ...
          <div
            ...
            <div id="${target.uuid}" class="${target.uuid} bg-white border-l-4  border-blue-500 mt-4 p-3">
